...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument("--image", type=str, default=r'./data/brain/test/2BA001/cbct.nii.gz')
        parser.add_argument("--result", type=str, default='./result/predict.nii.gz', help='path to the .nii result to save')
